...
{
    /// <inheritdoc />
    public partial class Fix_AddMissingForumAndFeedbackMessageTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ForumImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ForumImages_ForumPosts_ForumPostId",
                        column: x => x.ForumPostId,
                        principalTable: "ForumPosts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ForumReactions_ForumPosts_ForumPostId",
                        column: x => x.ForumPostId,
                        principalTable: "ForumPosts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ForumImages_ForumPostId",
                table: "ForumImages",
                column: "ForumPostId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ForumReactions_ForumPostId_UserId",
